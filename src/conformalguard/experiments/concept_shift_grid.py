...
class ConceptShiftGridSummary:
    """Aggregate metrics for one concept-shift severity."""
...
def run_concept_shift_grid(
    ...
    *,
    ...
    """Run concept-shift sweeps across multiple random seeds."""
...
def summarize_concept_shift_grid(
    results: Iterable[ConceptShiftExperimentResult],
) -> tuple[ConceptShiftGridSummary, ...]:
    """Aggregate concept-shift results by severity."""
